...
import { OperatorArgumentValueTypeEnum, OperatorArgumentTypeEnum, OperatorOutputValueTypeEnum, OperatorTypeEnum } from './enums';
...
export const operators = [
  {
    ...
    type: OperatorTypeEnum.MATH_LOGIC,
    inputs: {
      fixedArguments: [],
      restArguments: [{
        name: '',
        valueType: [OperatorArgumentValueTypeEnum.INT, OperatorArgumentValueTypeEnum.FLOAT],
        type: OperatorArgumentTypeEnum.BOTH
      }],
      minArguments: 2,
      maxArguments: 999
    },
    output: { name: 'result', type: OperatorOutputValueTypeEnum.NUMBER }
  },
  {
    name: 'subtract',
  ...
  },
  {
    ...
    output: { name: 'result', type: OperatorOutputValueTypeEnum.FLOAT }
  },
  {
    name: 'neg',
  ...
  },
  {
    ...
    output: { name: 'result', type: OperatorOutputValueTypeEnum.INT }
  },
  {
    name: 'inv',
  ...
  },
  {
    ...
    inputs: {
      fixedArguments: [
        ...
        {
          name: 'b',
          valueType: [OperatorArgumentValueTypeEnum.FLOAT],
          type: OperatorArgumentTypeEnum.CONSTANT
        }
      ],
      restArguments: [],
      minArguments: 2,
  ...
  },
  {
    ...
    inputs: {
      ...
      restArguments: [{
        name: '',
        valueType: [OperatorArgumentValueTypeEnum.BOOL],
        type: OperatorArgumentTypeEnum.BOTH
      }],
      minArguments: 2,
      maxArguments: 999
    },
    output: { name: 'result', type: OperatorOutputValueTypeEnum.BOOL }
  },
  {
    name: 'or',
      ...
      fixedArguments: [
        {
          name: 'x',
          valueType: [
            OperatorArgumentValueTypeEnum.BOOL,
            OperatorArgumentValueTypeEnum.FLOAT,
            OperatorArgumentValueTypeEnum.INT,
            OperatorArgumentValueTypeEnum.STRING,
            OperatorArgumentValueTypeEnum.GROUP
          ],
          type: OperatorArgumentTypeEnum.BOTH
        },
        {
  ...
  },
  {
    ...
    output: { name: 'result', type: OperatorOutputValueTypeEnum.ANY }
  },
  {
    name: 'identity',
  ...
  // ==================================================
  {
    ...
    type: OperatorTypeEnum.TIME_SERIES_OPERATIONS,
    inputs: {
      fixedArguments: [
        {
          name: 'x',
        ...
        {
          name: 'd',
          valueType: [OperatorArgumentValueTypeEnum.INT],
          type: OperatorArgumentTypeEnum.CONSTANT
        }
      ],
      restArguments: [],
  ...
  },
  {
    ...
    output: { name: 'result', type: OperatorOutputValueTypeEnum.ANY } // Assuming ANY maps to FLOAT usually
  },
  {
    name: 'delta',
  ...
  },
  {
    ...
    inputs: {
      fixedArguments: [
        ...
        {
          name: 'direction',
          valueType: [OperatorArgumentValueTypeEnum.STRING],
          type: OperatorArgumentTypeEnum.CONSTANT
        }
      ],
      restArguments: [],
  ...
  // ==================================================
  {
    ...
    type: OperatorTypeEnum.CROSS_SECTIONAL_OR_GROUPED_OPERATIONS,
    inputs: {
      fixedArguments: [{
        name: 'x',
        valueType: [OperatorArgumentValueTypeEnum.INT, OperatorArgumentValueTypeEnum.FLOAT],
  ...
  },
  {
    ...
    inputs: {
      fixedArguments: [
        ...
        {
          name: 'G',
          valueType: [OperatorArgumentValueTypeEnum.GROUP],
          type: OperatorArgumentTypeEnum.BOTH
        }
      ],
      restArguments: [],
