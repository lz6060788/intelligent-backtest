const translation = {
  ...
  nodes: {
    ...
    backtest: {
      ticker: 'Ticker',
      tickerPlaceholder: 'Input ticker',
      start_date: 'Start Date',
      end_date: 'End Date',
      price_type: 'Price Type',
      end_datePlaceholder: 'Select end date',
      start_datePlaceholder: 'Select start date',
      price_typePlaceholder: 'Select price type',
      execution_signals: {
        open: 'Open Signal',
        close: 'Close Signal',
        openPlaceholder: 'Select open signal Dates',
        closePlaceholder: 'Select close signal Dates',
        signalVariablePlaceholder: 'Select signal variable',
        manual: 'Manual',
        auto: 'Auto',
      },
      risk_control: {
        ...
        stop_lossPlaceholder: 'Enter stop loss',
        take_profitPlaceholder: 'Enter take profit',
        max_hold_daysPlaceholder: 'Enter max hold days',
        max_drawdownPlaceholder: 'Enter max drawdown',
        addRiskControlItem: 'Add Risk Control Item',
        notNumber: '{field} is not a valid number',
        constant: 'Constant',
        variable: 'Variable',
        variablePlaceholder: 'Select variable value',
      },
