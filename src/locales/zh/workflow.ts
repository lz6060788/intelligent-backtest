const translation = {
  ...
  nodes: {
    ...
    backtest: {
      ...
      end_date: '结束日期',
      price_type: '价格类型',
      start_datePlaceholder: '选择开始日期',
      end_datePlaceholder: '选择结束日期',
      price_typePlaceholder: '选择价格类型',
      execution_signals: {
        open: '开仓信号',
        close: '平仓信号',
        openPlaceholder: '选择开仓信号日期',
        closePlaceholder: '选择平仓信号日期',
        signalVariablePlaceholder: '选择信号变量',
        manual: '手动',
        auto: '自动',
      },
      risk_control: {
        ...
        max_drawdown: '最大回撤',
        stop_lossPlaceholder: '输入止损',
        take_profitPlaceholder: '输入止盈',
        max_hold_daysPlaceholder: '输入最大持仓天数',
        max_drawdownPlaceholder: '输入最大回撤',
        addRiskControlItem: '添加风险控制项',
        notNumber: '{field} 不是一个有效的数字',
        constant: '常量',
        variable: '变量',
        variablePlaceholder: '选择变量值',
      },
      outputDescribe: '回测结果',
    },
  },
